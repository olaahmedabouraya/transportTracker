...
const HomeScreen = () => {
  ...
  const [newOrder, setNewOrder] = useState({
    ...
    originLatitude: 31.237018911458113,
    originLongitude: 29.95751433731303,

    destLatitude: 31.237018911458113,
    destLongitude: 29.95751433731303,
  ...
  const onUserLocationChange = event => {
    console.log('Hello ' + JSON.stringify(event.nativeEvent));
